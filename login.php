...
$sql = "SELECT * FROM elantris_db.tbl_users WHERE username='" . $username . "'";
...
-->
                <div class="col-lg-12">
                    ...
                    <input type="submit" value="Login" name="submit">
                        <?php
                        if($login_msg == 1){
                            echo '<p id="login-msg">Login successful</p>';
                        }
                        if($login_msg == 2){
                            echo '<p id="login-error">Authentication failed, please try again.</p>';
                        }
